            ...
            <div class="col-span-4 sm:col-span-9">
              <div class="bg-white shadow w-full rounded-3xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 ">
                  ...
                  <div className="rounded-lg border border-gray-300 p-4">
                  <label htmlFor="rollNumber" className="text-gray-600">Roll Number:</label>
                  <input
                    type="text"
                    id="rollNumber"
                    name="rollNumber"
                  ...
                  <div className="rounded-lg border border-gray-300 p-4">
                  <label htmlFor="fatherName" className="text-gray-600">Father's Name:</label>
                  <input
                    type="text"
                    id="fatherName"
                    name="fatherName"
                  ...
                  <div className="rounded-lg border border-gray-300 p-4">
                  <label htmlFor="motherName" className="text-gray-600">Mother's Name:</label>
                  <input
                    type="text"
                    id="motherName"
                    name="motherName"
